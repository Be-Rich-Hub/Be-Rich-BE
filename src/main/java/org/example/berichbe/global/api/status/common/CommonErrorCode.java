...
public enum CommonErrorCode implements ErrorCode {
    ...
    ILLEGAL_ARGUMENT(HttpStatus.BAD_REQUEST, "COMMON400_1", "잘못된 인자입니다."),
    ILLEGAL_STATE(HttpStatus.BAD_REQUEST, "COMMON400_2", "잘못된 상태입니다."),
    BUDGET_CANNOT_BE_NEGATIVE(HttpStatus.BAD_REQUEST, "COMMON400_3", "예산은 음수일 수 없습니다."),
    
    // 401 Unauthorized
    UNAUTHORIZED(HttpStatus.UNAUTHORIZED, "COMMON401_1", "인증되지 않은 사용자입니다."),
